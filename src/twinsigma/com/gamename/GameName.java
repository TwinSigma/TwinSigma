...
import twinsigma.com.gamename.elements.PerspectiveEnum;
	...
	public GameName(){
		...
		Thread init = new Thread("Initialization"){
			...
			public void run(){
				...
				scene = new Scene(PerspectiveEnum.OVERHEAD, new Background(0, 0, Window.WIDTH, Window.HEIGHT, 0, ResourceManager.grass),
